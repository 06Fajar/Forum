...
class KomenDetail extends StatefulWidget {
  int idParent;
  int replyTo;
  KomenDetail({Key? key, required this.idParent, required this.replyTo})
      : super(key: key);
...
class _ForumDetailState extends State<KomenDetail> {
